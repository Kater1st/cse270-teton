...
def _local_server_ready(host="127.0.0.1", port=5500, timeout=1):
    import socket
    try:
...
class TestSmokeTest():
  def setup_method(self, method):
    ...
    if not _local_server_ready():
        pytest.skip("Local HTTP server not reachable; smoke tests require it")
  ...
  def test_adminPage(self):
    ...
    self.driver.set_window_size(1245, 1039)
  ...
  def test_directoryPage(self):
    self.driver.get("http://127.0.0.1:5500/cse270/teton/1.6/index.html")
    self.driver.set_window_size(1237, 1039)
  ...
  def test_homePage(self):
    self.driver.get("http://127.0.0.1:5500/cse270/teton/1.6/index.html")
    self.driver.set_window_size(1235, 1039)
  ...
  def test_joinPage(self):
    self.driver.get("http://127.0.0.1:5500/cse270/teton/1.6/index.html")
    self.driver.set_window_size(1238, 1039)
    self.driver.find_element(By.LINK_TEXT, "Join").click()
    elements = self.driver.find_elements(By.NAME, "fname")
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").click()
    self.driver.find_element(By.NAME, "fname").send_keys("Tinashe")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Katenaire")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Katercraft")
